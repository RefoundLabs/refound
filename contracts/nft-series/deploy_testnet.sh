...
# Deploy Contract
NEAR_ENV=testnet near deploy --wasmFile ./target/wasm32-unknown-unknown/release/nft_simple.wasm  --initFunction new_default_meta --initArgs '{"owner_id": "'$ADMIN_ADDRESS'"}'  --accountId $CONTRACT_ADDRESS
